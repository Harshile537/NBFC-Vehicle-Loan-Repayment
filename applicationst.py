...
with open("D:\Final_project\VehicleLoan_Classification_Model_AFHP.pkl","rb") as f1:
    class_model_afhp= pickle.load(f1)

st.set_page_config(layout="wide")
st.title(":blue[**NBFC Vehicle Loan Repayment**]")
st.write("")
with st.sidebar:
...
if select == "Home":
     ...
     img= Image.open(r"D:\Final_project\Popular-NBFC-in-India.jpg")
     col1 = st.columns(1)
     with col1:
